...
export const Route = createFileRoute("/_authenticated/agent/add-property" as never)({
  ...
  if (role !== "agent" && role !== "admin") {
    return (
      <div className="mx-auto max-w-md px-4 py-20 text-center">
        ...
        <Link to="/dashboard" className="mt-5 inline-block text-sm text-primary hover:underline">
          Back to dashboard
        </Link>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      <div className="mb-8 flex flex-wrap items-start justify-between gap-4">
        ...
        <Button type="button" variant="outline" onClick={() => navigate({ to: "/agent" })} className="gap-2">
      ...
      <form onSubmit={onSubmit} className="space-y-8">
        <section className="rounded-2xl border bg-card p-6">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div className="space-y-2 md:col-span-2">
              <Label htmlFor="agent-title">Property Title *</Label>
              <Input
                id="agent-title"
                required
                value={form.title}
            ...
            <div className="space-y-2">
              ...
              <Select value={form.property_type} onValueChange={(value) => setForm((current) => ({ ...current, property_type: value as PropertyType }))}>
            ...
            <div className="space-y-2">
              ...
              <Select value={form.listing_type} onValueChange={(value) => setForm((current) => ({ ...current, listing_type: value as ListingType }))}>
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Textarea
                ...
                placeholder="Describe the property, nearby landmarks, condition, and main selling points."
              />
            </div>
          </div>
        </section>
        ...
        <section className="rounded-2xl border bg-card p-6">
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Use clear real photos where possible. The first image becomes the cover photo.</p>
          </div>
        ...
        <div className="flex flex-wrap gap-3 pb-6">
          ...
          <Button type="button" variant="outline" onClick={() => { setForm(EMPTY_FORM); setImages([]); }}>
            Clear
          </Button>
        </div>
      </form>
